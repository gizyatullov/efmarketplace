...
from efmarketplace.db.dao import UserDAO
...
class UserService:
    ...
    def __init__(self, user_repository: UserDAO):
    ...
    async def delete_specific_user(self, cmd: schemas.DeleteUserCommand) -> schemas.User:
